...
def run_training(epochs, a_mse, a_content, a_style, a_spst, beta, content_layer, style_layer, 
    ...
    for epoch in range(last_epoch, epochs):
        ...
        if save_condition:
            ...
            training_loss_autocorr_grid = torch.cat([training_input_autocorr, training_recon_autocorr], axis=1)
            ...
            validation_loss_autocorr_grid = torch.cat([validation_input_autocorr, validation_recon_autocorr], axis=1)
